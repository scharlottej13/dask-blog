...
Reference: [Pull request #7869 by Freyam Mehta *"Add node size scaling to the Graphviz output for the high level graphs"*](https://github.com/dask/dask/pull/7869)
...
Reference: [Pull request #7973 by Freyam Mehta *"Add tooltips to graphviz"*](https://github.com/dask/dask/pull/7973)
...
Reference: [Pull request #7974 by Freyam Mehta *"Add colors to represent high level layer types"*](https://github.com/dask/dask/pull/7974)
...
Reference: [Pull request #7740 by Freyam Mehta *"Fixing calling .visualize() with filename=None"*](https://github.com/dask/dask/pull/7740)
...
Reference: [Pull request #7886 by Freyam Mehta *"Add dask.array SVG to the HTML Repr"*](https://github.com/dask/dask/pull/7886)
...
<img src="/images/gsoc21/5181.png" alt="Example: New HTML representation for distributed ProcessInterface class, pull request #5181" height=414 width=736>

Reference: [Pull request #5181 by Freyam Mehta *"Add HTML Repr for ProcessInterface Class and all its subclasses"*](https://github.com/dask/distributed/pull/5181)
...
```python
from dsak.distributed import Security
...
<img src="/images/gsoc21/5178.png" alt="Example: New HTML representation for distributed Security class, pull request #5178" height=414 width=736>

Reference: [Pull request #5178 by Freyam Mehta *"Add HTML Repr for Security Class"*](https://github.com/dask/distributed/pull/5178/)
